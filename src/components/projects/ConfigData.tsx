          ...
          {projectData.status && (
            <div className="flex items-center gap-2">
              ...
              <span className={`text-sm px-2 py-1 rounded-full ${
                projectData.status === 'Completed' ? 'bg-green-100 text-green-800 dark:bg-green-900/40 dark:text-green-200' :
                projectData.status === 'Ongoing' ? 'bg-blue-100 text-blue-800 dark:bg-blue-900/40 dark:text-blue-200' :
