        ...
        <div className="w-full space-y-4">
          ...
          {showAIOption && (
            <ChatBubble variant="received">
              <ChatBubbleMessage className="bg-card/80 w-full">
                  ...
                  {onClose && (
                    <div className="flex justify-end">
                      <Button
                        ...
                        variant="ghost"
                        size="sm"
                        className="hover:bg-muted h-6 w-6 rounded-full p-0"
                      >
                        <X className="w-4 h-4" />
                      </Button>
                    </div>
                  ...
                  <div className="flex flex-col gap-3 px-2">
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                      <div className="flex items-center gap-2 flex-wrap">
                        ...
                        <span className="text-muted-foreground text-xs">• I implemented this to save API quota</span>
                      </div>
                      <Button 
        ...
        <ChatBubble variant="received">
          <ChatBubbleMessage className="bg-gradient-to-r from-blue-50/50 to-purple-50/50 dark:from-blue-900/20 dark:to-purple-900/20 border border-blue-100/50 dark:border-blue-800/50 w-full">
            <div className="space-y-4 p-6 w-full">
              ...
              <div className="prose prose-sm text-foreground max-w-none px-2">
                {reply.split('\n').map((line, index) => {
                  ...
                  if (line.includes('Download Resume Here') && line.includes('http')) {
                    ...
                    if (urlMatch) {
                      return (
                        <div key={index} className="mb-4 rounded-xl border border-blue-400/30 bg-blue-500/10 p-4 shadow-sm">
                          <div className="flex items-center justify-between">
                            <div className="flex items-center gap-3">
                              ...
                              <div>
                                <span className="text-foreground block font-semibold">Resume Available</span>
                                <span className="text-muted-foreground text-xs">Click to download PDF</span>
                              </div>
                            </div>
                            <Button
                  ...
                  if (/^[🎯🚀💼🏆📊🔧🌟💡🎓📍🌍⚡🤝]/u.test(line)) {
                    return (
                      <p key={index} className="text-foreground mb-2 text-base font-medium last:mb-0">
                        {line}
                      </p>
                    );
                  }
                  ...
                  if (line.startsWith('• ') || line.startsWith('- ')) {
                    return (
                      <p key={index} className="text-muted-foreground mb-1 ml-4 last:mb-0">
                        {line}
                      </p>
                    );
                  }
