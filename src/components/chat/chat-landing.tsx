    ...
    >
      ...
      <motion.div className="mb-8" variants={itemVariants}>
        <motion.button
          ...
          className="bg-card hover:bg-muted border-border text-foreground flex items-center gap-2 rounded-full border px-6 py-3 text-sm font-medium shadow-sm transition-all duration-200 hover:shadow-md mx-auto"
